    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TemaActivity.this, Settings.class);
        ...
        switchBrilloAutomatico.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    mostrarMensaje("Modo BrilloAutomatico Activado");
                } else {
                    activarBrilloAutomatico(false);
                    mostrarMensaje("Modo BrilloAutomatico Desactivado");
                }
            }
        });
